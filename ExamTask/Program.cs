// Метод. Определить длину нового массива = посчитать количество элементов в исходном массиве с длинной элемента не боле 3 символов
// создаю в связи с запретом использовать коллекции с динамической длинной, только массивы с фикс
...
while (inLen < 1 ) // провеерить корректность длины; здесь не заморачиваюсь на проверки того что не пусто, что не текст, что целое положительное число; так как это не основная задача
{
